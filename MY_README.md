<<<<<<< HEAD
In this project I will use pre-written test files and make the tests pass by writing the appropriate Ruby code from scratch. I will display my working knowledge of Ruby, RSpec, and test driven development.

From The Odin Project's [curriculum](https://www.theodinproject.com/courses/web-development-101/lessons/ruby?ref=lc-pb)
=======
