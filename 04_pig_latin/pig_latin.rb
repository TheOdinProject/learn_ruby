...
module PigLatinTranslator
    ...
    # this solution uses regular expression to match search patterns
    ...
    def translateword(word)
        ...
        when /([^aeiouy])+)(.*)/
            ...
            # also note the use of paranthesis as in the previous case
            # '$1' varible here will capture the leading consonants in a word.
    ...
    def translate(phrase)
        ...
        # print a trace here if you want to see what is happenning
